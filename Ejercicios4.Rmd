...
sprintf("Numero de pacientes esperados con efectos secundarios: %s", media)
...
output <- c(
  ...
  sprintf("los proximos 15 min: %s", probability)
)
...
output <- c(
  sprintf("La probabilidad de una accion tenga un costo menor que"),
...
output <- c(
  sprintf("La probabilidad de una accion tenga un costo menor"),
